// POST /api/notifications/whatsapp/image  { to, link | id, caption? }
...
export async function POST(event) {
	...
	const res = await NotificationService.send({ channel: Channel.WHATSAPP, type: 'image', to: body.to, link: body.link, id: body.id, caption: body.caption });
