// Super-admin "CEO console": one honest, real-data snapshot of the whole
// platform. Everything derives from existing tables (no fabricated bookings,
// GMV, geography, or historical snapshots) via pure helpers in server/admin.js.
