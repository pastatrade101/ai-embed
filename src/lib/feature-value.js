...
export const FEATURE_VALUE = {
	...
	'Email lead alerts': 'Get an email the moment a sales-ready lead arrives.',
	...
	'AI data analyst': 'Ask your numbers anything — top performers, where leads stall — answered instantly.',
	...
	'Hosted AI page + QR code': 'A ready-made page and QR code — no website needed.',
	'WhatsApp lead handoff': 'Send sales-ready customers straight to your WhatsApp with full context.',
