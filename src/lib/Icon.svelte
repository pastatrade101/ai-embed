<script>
	// Inlined Lucide / Feather icons (MIT-licensed) — a lightweight icon set with
	// no runtime dependency. Colour follows `currentColor`; size/stroke are props.
	export let name;
	export let size = 24;
	export let stroke = 2;
</script>
